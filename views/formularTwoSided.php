...
if(!$pdfGenerator ->mailcheck($mail))
	...
	if ($errMsg == "")
	{
		...
		$data1Array = array($name, $function1, $function2, $abteilung, $zusatz, $dnr, $mnr, $fax, $mail);
		$data2Array = array($name, $function1, $function2, $abteilung, $zusatz, $dnr, $mnr, $fax, $mail);
		
		$pdfGenerator->generateTwoSided($typ, $data1Array, $_SESSION['username'], $anz);
		$msg = 'Herzlichen Dank f&uuml;r Ihre Bestellung! <br /> <a href="index.php?site=auswahl">Neue Visitenkarte erstellen</a>';
...
if (agree)
	...
	return false ;
			...
			<div style="background:white;position:absolute;top:0px;left:480px;height:255px;width:400px;border-style:solid;border-color:#000;border-width:1px;margin-left:0;margin-top:0px;">
